...
def setchatpic(update: Update, context: CallbackContext):
    ...
    if msg.reply_to_message:
        if msg.reply_to_message.photo:
            ...
            msg.reply_text(
                "Anda hanya dapat mengatur beberapa foto sebagai foto obrolan!"
            )
            return
        ...
        msg.reply_text(
            "Balas beberapa foto atau file untuk mengatur foto obrolan baru!"
        )
...
def setchat_title(update: Update, context: CallbackContext):
    ...
    if user_can_changeinfo(chat, user, context.bot.id) is False:
        msg.reply_text(
            "Anda tidak memiliki hak yang cukup untuk mengubah info obrolan!"
        )
        return
    ...
    if not title:
        msg.reply_text(
            "Masukkan beberapa teks untuk mengatur judul baru di obrolan Anda!"
        )
        return
...
def promote(update: Update, context: CallbackContext) -> str:
    ...
    if (
        ...
        message.reply_text(
            "Anda tidak memiliki hak yang diperlukan untuk melakukan itu!"
        )
        return
    ...
    if user_id == bot.id:
        message.reply_text(
            "Saya tidak bisa mempromosikan diri sendiri! Minta admin untuk melakukannya untuk saya."
        )
        return
    ...
    try:
        ...
        if err.message == "User_not_mutual_contact":
            message.reply_text(
                "Saya tidak bisa mempromosikan seseorang yang tidak ada dalam grup."
            )
        else:
...
def lowpromote(update: Update, context: CallbackContext) -> str:
    ...
    if user_id == bot.id:
        message.reply_text(
            "Saya tidak bisa mempromosikan diri saya sendiri! Minta admin untuk melakukannya untuk saya."
        )
        return
...
def fullpromote(update: Update, context: CallbackContext) -> str:
    ...
    if user_member.status in ("administrator", "creator"):
        message.reply_text(
            "Bagaimana saya bisa mempromosikan seseorang yang sudah menjadi admin?"
        )
        return
        ...
        try:
            ...
            msg.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton("👉 Buka pesan", url=f"{message_link}")]]
                ),
                parse_mode=ParseMode.HTML,
...
def unpin(update: Update, context: CallbackContext):
    ...
    if not prev_message and is_group:
        try:
            ...
            msg.reply_text("Unpinned pesan yang disematkan terakhir.")
        except BadRequest as excp:
