...
async def hmm(_, message):
    ...
    if status == "ON" or status == "on" or status == "On":
        ...
        if not lol:
            ...
            return
        await lel.edit(
            f"FAHRI AI Di-actifkan oleh {message.from_user.mention()} untuk pengguna di {message.chat.title}"
        )
        ...
        if not Escobar:
            ...
            return
        await lel.edit(
            f"FAHRI AI Dinonaktifkan oleh {message.from_user.mention()} untuk pengguna di {message.chat.title}"
        )
